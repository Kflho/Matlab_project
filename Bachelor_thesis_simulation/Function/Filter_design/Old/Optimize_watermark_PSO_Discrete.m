function [best_Dw, best_Cw, global_best_cost] = Optimize_watermark_PSO_Discrete(A, B, C, K, K_KF, Cj, Dj, epsilon_r, epsilon_a)
% =========================================================================
...
for iter = 1:max_iter
    ...
    for i = 1:num_particles
        % --- 计算适应度 ---
        cost = evaluate_Fitness(Positions(i, :), A, B, C, K, K_KF, Cj, Dj, epsilon_r, epsilon_a, options);
        ...
        if cost < gBest_Score
            ...
            save('Temp_Best_Watermark.mat', 'temp_Dw', 'temp_Cw', 'gBest_Score');
            % =======================================================
        end
    end
