...
% 性能损失矩阵（正常/受攻击） [无, 弱, 强]
C_0 = [2.8559, 52.8582, 52.8604];
C_A = [1140.4630, 479.1834+50, 1442.7575+50];

% 检测性能参数（基于实验9新阈值数据）
DetRate = [0.8202, 0.6405, 0.8429];        % 检测率   [无水印, 弱水印, 强水印]
FalseAlarmRate = [0.1080, 0.2240, 0.1120]; % 误报率   [无水印, 弱水印, 强水印]
